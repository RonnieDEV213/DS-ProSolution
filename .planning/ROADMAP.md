...
- [ ] **Phase 28.1: v4 Tech Debt Cleanup** - Address 4 non-blocking tech debt items from v4 milestone audit
  **Plans:** TBD
  - [ ] Fix naming inconsistency: align /admin/automation breadcrumb + PageHeader naming
  - [ ] Remove stale standalone pages (/admin/department-roles, /admin/invites) orphaned by modal consolidation
  - [ ] Remove dead SPACING/GAPS exports from lib/spacing.ts
  - [ ] Wire CardGridSkeleton into a page or remove unused component
...
**Total:** 4 milestones, 28.1 phases, 107 plans (106 shipped, 1 gap closure, 1 tech debt)

---
*Roadmap created: 2026-01-17*
*Last updated: 2026-01-27 - Phase 28.1 added: v4 tech debt cleanup from milestone audit*
