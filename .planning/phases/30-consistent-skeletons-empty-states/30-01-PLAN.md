...
<success_criteria>
- All 4 "Loading..." occurrences in these files replaced with skeleton components
- No TypeScript compilation errors
- Loading guard pattern uses `loading && !data` (not just `loading`)
- SKEL-01 (legacy admin page skeletons) was pre-satisfied by Phase 29's useCachedQuery integration across the 5 legacy admin pages (/admin, /admin/users, /admin/department-roles, /admin/invites, /va/accounts). This plan extends skeleton coverage to the VA layout shell and 3 automation sub-page tables, advancing SKEL-03 (no page shows a "Loading..." text string).
</success_criteria>
