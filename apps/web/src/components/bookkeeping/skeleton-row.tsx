...
export function SkeletonRow({ style, density }: SkeletonRowProps) {
  ...
  return (
    ...
    >
      ...
      <div className="h-3 w-24 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-32 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-8 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-20 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-20 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-20 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-24 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-24 skeleton-shimmer rounded ml-6" />
      <div className="h-3 w-6 skeleton-shimmer rounded ml-6" />
    </div>
  );
}
